...
const CONFIG_DIR   = "./docs/docgen";
const OUTPUT_DIR   = "./docs/docgen/docs";
const README_FILE  = "./docs/docgen/README.md";
const SUMMARY_FILE = "./docs/docgen/SUMMARY.md";
const EXCLUDE_FILE = "./docs/docgen/exclude.txt";
